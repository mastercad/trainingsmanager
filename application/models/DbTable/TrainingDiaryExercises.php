...
class Application_Model_DbTable_TrainingDiaryExercises extends Application_Model_DbTable_Abstract
{
     ...
     * @var string
     */
    protected $_name 	= 'trainingstagebuch_uebungen';
    /**
     * @var string
     */
    protected $_primary = 'trainingstagebuch_uebung_id';

    /**
     * @param $iTrainingsplanUebungId
...
//        Zend_Debug::dump($this->getAdapter()->getProfiler()->getLastQueryProfile()->getQuery());
    ...
    /**
     * @param $iTrainingsplanId
     * @return Zend_Db_Table_Rowset_Abstract
     */
    public function getLastTrainingstagebuchUebungen($iTrainingsplanId)
    {
