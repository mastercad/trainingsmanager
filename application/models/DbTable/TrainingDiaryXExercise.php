...
class Model_DbTable_TrainingDiaryXExercise extends Model_DbTable_Abstract
{
    /**
     * @var string
     */
    protected $_name 	= 'training_diary_x_exercise';
    /**
     * @var string
     */
    protected $_primary = 'training_diary_x_exercise_id';
     ...
     */
    public function getActualTrainingDiaryByExerciseId($iTrainingPlanXExerciseId)
    {
//        $this->getAdapter()->getProfiler()->setEnabled(TRUE);
        return $this->fetchRow('training_diary_x_training_plan_exercise_fk = ' . $iTrainingPlanXExerciseId,
