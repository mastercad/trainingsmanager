...
class Model_DbTable_TrainingDiaryXExerciseOption extends Model_DbTable_Abstract
{
    ...
    public function findExerciseOptionsByTrainingDiaryTrainingPlanExerciseId($trainingDiaryTrainingPlanExerciseId)
    {
        ...
        $oSelect->joinInner($this->considerTestUserForTableName('exercise_options'), 'exercise_option_id = training_diary_x_exercise_option_exercise_option_fk')
            ->joinInner($this->considerTestUserForTableName('training_diary_x_training_plan_exercise'), 'training_diary_x_training_plan_exercise_id = ' . $trainingDiaryTrainingPlanExerciseId)
    ...
    public function findAllExerciseOptions($userId = null) {
        ...
        $select->joinInner($this->considerTestUserForTableName('training_diary_x_training_plan_exercise'), 'training_diary_x_training_plan_exercise_id = training_diary_x_exercise_option_t_d_x_t_p_e_fk')
            ...
            ->columns([
                ...
                $this->considerTestUserForTableName('training_plan_x_exercise_option') . '.training_plan_x_exercise_option_exercise_option_value',
