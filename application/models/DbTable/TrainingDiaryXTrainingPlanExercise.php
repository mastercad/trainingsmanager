...
//        Zend_Debug::dump($this->getAdapter()->getProfiler()->getLastQueryProfile()->getQuery());
    ...
    public function checkTrainingDiaryFinished($trainingDiaryXTrainingPlanExerciseId)
    {
        ...
        $oSelect->joinInner('training_plan_x_exercise', 'training_plan_x_exercise_id = training_diary_x_training_plan_exercise_t_p_x_e_fk')
            ...
            ->joinLeft('training_diary_x_training_plan_exercise AS trainingDiaryXTrainingPlanExercises', 'trainingDiaryXTrainingPlanExercises.training_diary_x_training_plan_exercise_t_p_x_e_fk = trainingPlanExercises.training_plan_x_exercise_id AND trainingDiaryXTrainingPlanExercises.training_diary_x_training_plan_exercise_training_diary_fk = training_diary_x_training_plan_exercise.training_diary_x_training_plan_exercise_training_diary_fk')
